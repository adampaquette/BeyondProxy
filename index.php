<?php
/*
Script from : <https://github.com/naster01/BeyondProxy>
Old script from : <https://github.com/joshdick/miniProxy>
...
{ 
    $doc = new DomDocument();
    @$doc->loadHTML(utf8_decode($file["data"])); //utf8_decode = quick fix : obtain the real encoding 
